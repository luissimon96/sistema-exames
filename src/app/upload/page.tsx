...
export default function UploadPage() {
  ...
  // Função para lidar com a geração do token CSRF
  // useCallback para manter a referência estável e evitar re-renderizações desnecessárias
  ...
  const handleUpload = async () => {
    ...
    if (!csrfToken) {
      setError('Erro de segurança: Token CSRF não encontrado. Tente recarregar a página.')
      return
    }
    ...
    try {
      ...
      console.log('Enviando requisição com token CSRF:', csrfToken.substring(0, 20) + '...');
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <div className="bg-white shadow sm:rounded-lg p-6">
        {/* Componente para gerar e gerenciar o token CSRF */}
        <CsrfToken onTokenGenerated={handleTokenGenerated} />
