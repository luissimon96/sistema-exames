...
export default function SocialMediaLinks({
  ...
  // Função para salvar as redes sociais
  const handleSave = () => {
    // Validar URLs
    if (!isValidUrl(facebook) || !isValidUrl(twitter) || !isValidUrl(linkedin) || !isValidUrl(instagram) || !isValidUrl(github)) {
      setError('Uma ou mais URLs são inválidas. Por favor, verifique e tente novamente.')
      return
    }
